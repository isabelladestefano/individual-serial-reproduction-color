...
rawDat =read_file("https://bradylab.ucsd.edu/turk/data/Isabella/iteratedColorsSS2_AnchorColor_fourLocations_15iter_30errorTol_V3_online")
...
for(f in 1:length(filenames)){
  raw_data[[f]] = fromJSON(url(paste0("https://bradylab.ucsd.edu/turk/data/Isabella/iteratedColorsSS2_AnchorColor_fourLocations_15iter_30errorTol_V3_online/",filenames[f])))
}
...
#write.csv(all_data_exp3, 'data/exp3/online/all_data_exp3_online.csv')
write_csv(test_data_exp3, "data/exp3/online/test_data_exp3_online.csv")
write_csv(chain_data_exp3, "data/exp3/online/chain_data_exp3_online.csv")
write_csv(demographics_data_exp3, "data/exp3/online/demographics_data_exp3_online.csv")
